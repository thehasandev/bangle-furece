...
function MangerBanner() {
  return (
    <section className='bg-securityBanner  bg-cover md:bg-cover  mt-16'>
        <div className='bg-black/50'>
            <Container>
                <div className='py-32'>
                    <h1 className='font-roboto font-bold text-white text-center text-4xl'>What to Look for in a Cleaning Manager</h1>
